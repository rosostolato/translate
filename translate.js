(function (global, factory) {
  ...
  (global = global || self, global.translate = factory());
  ...
  const Translate = function (options = {}) {
    ...
    const translate = (text, opts = {}) => {
      ...
      return fetch(...fetchOpts)
        .then(engine.parse)
        .then(translated => exp.put(opts.id, translated, opts.cache));
    };
  ...
  const exp$1 = new Translate();
  exp$1.Translate = Translate;
